export interface ProductTemplate {
  ...
  bots: Array<{ name: string; title: string; description: string; section: string }>;
  routines: Array<{ bot: string; name: string; prompt: string; cadence: "daily" | "weekdays" | "weekly"; at: string }>;
}
