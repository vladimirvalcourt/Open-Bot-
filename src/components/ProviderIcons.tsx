...
export function GrokMark({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={cn("fill-ink", className)}>
...
export function CodexMark({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 260" preserveAspectRatio="xMidYMid" className={cn("fill-ink", className)}>
...
export function GeminiMark({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={cn(className)} aria-hidden="true">
      <defs>
        <linearGradient id="gemini-mark" x1="3" y1="21" x2="21" y2="3" gradientUnits="userSpaceOnUse">
      ...
      <path
        ...
        d="M12 2c.55 5.69 4.31 9.45 10 10-5.69.55-9.45 4.31-10 10-.55-5.69-4.31-9.45-10-10 5.69-.55 9.45-4.31 10-10Z"
      />
    </svg>
  );
}
...
export function KimiMark({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={cn(className)} aria-hidden="true">
      ...
      <path d="M7 5.5v13M17 5.5 10.5 12l6.5 6.5" fill="none" stroke="#fff" strokeWidth="2.3" strokeLinecap="round" strokeLinejoin="round" />
      <circle cx="17.25" cy="6.1" r="2.15" fill="#2F6BFF" />
    </svg>
  );
}
